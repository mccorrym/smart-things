...
def illuminanceChangeHandler (evt) {
	// Assume one or more switches is ON. If any of the switches in the array are OFF, perform the routine on all switches.
    def switch_status = "on"
