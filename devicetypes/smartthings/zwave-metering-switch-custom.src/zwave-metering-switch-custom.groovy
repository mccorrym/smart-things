 ...
 */
metadata {
	definition (name: "Z-Wave Metering Switch (Custom)", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.switch", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, genericHandler: "Z-Wave",  mnmn: "SmartThingsCommunity", vid: "0b6b840e-e505-3eff-a7de-28331676fc3f") {
	...
	tiles(scale: 2) {
		...
		main(["power","switch","energy"])
		details(["power","switch","energy","refresh","reset"])
	}
}
